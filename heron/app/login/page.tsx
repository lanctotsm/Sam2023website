...
export default async function LoginPage({
  ...
  return (
    <div className="grid gap-4">
      <h1 className="text-chestnut dark:text-dark-text">Login</h1>
      <p className="text-chestnut-dark dark:text-dark-muted">Sign in with Google to upload photos and manage content.</p>
